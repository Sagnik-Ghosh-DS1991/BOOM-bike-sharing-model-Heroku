...
app=Flask(__name__)
model=jb.load("D:\Data Science\Python projects\pycharm\ML model deployment\BOOM Bike sharing regression\models\Boom_bike_lr_model.pkl")
scaling=jb.load("D:\Data Science\Python projects\pycharm\ML model deployment\BOOM Bike sharing regression\models\Boom_bike_scaling.pkl")
